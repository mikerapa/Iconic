...
class PathInput(Static):
    ...
    def __init__(self, allow_folders: bool = True, allow_files: bool = True, classes: str = ""):
    ...
    def validate_path(self, _: str | None = None) -> None:
        ...
        self.logger.info(f"Path is valid: {self.is_valid} {self.folder_path} allow_folders: {self.allow_folders}, allow_files: {self.allow_files}")
        ...
        print(f"Path is valid: {self.is_valid} {self.folder_path}, allow_folders: {self.allow_folders}, allow_files: {self.allow_files}")
        # Update styles based on validity
        invalid_style = "color: red"
        valid_style = "color: white"
